...
.nc-img{aspect-ratio:1/1;position:relative;overflow:hidden;background:linear-gradient(135deg,#080A14,#0E0A20);display:flex;align-items:center;justify-content:center}
.nc-img img{width:100%;height:100%;object-fit:cover;object-position:center 35%;display:block}
